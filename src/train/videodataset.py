...
class IntermediateRewardDataset(datasets.GeneratorBasedBuilder):
            ...
            features=datasets.Features(
                {
                    ...
                    "intermediate": datasets.Array2D(shape=(1, 29754), dtype="float32"),
    ...
    def _generate_examples(self, **kwargs):
        ...
        with load_vision_model(model_fullname(MODEL_CONFIGS["yolov7-tiny-final3-s53"])) as intermediate_engine, \
